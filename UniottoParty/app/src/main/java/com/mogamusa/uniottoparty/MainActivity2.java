...
public class MainActivity2 extends AppCompatActivity implements View.OnClickListener{
            ...
            public void run() {
                ...
                while (true) {
                    ...
                    handler2.post(new Runnable() {
                        @Override
                        public void run() {
                            countView.setText(""+mApp.getCount());
                        }
                    });
    ...
    public void onPlayButtonClick(View view) {
        Intent intent = new Intent(MainActivity2.this, SoundManageService.class);
        startService(intent);
        /*
        Button btPlay = (Button) findViewById(R.id.btPlay);
        Button btStop = (Button) findViewById(R.id.btStop);
    ...
    public void musicListFunc(){
        /*
        listF = new ArrayList<>();
        adapterFapi = new AlbumAdapter(MainActivity.this);
    ...
    public void recommendListFunc(View v){
        ...
        listR = new ArrayList<>();
        adapterRapi = new AlbumAdapter(MainActivity2.this);
    ...
    public void playlist(){
        ...
        velplaylist=new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot){
                ...
                i=0;
                listPre = new ArrayList<>();
                adapterPre = new AlbumAdapter(MainActivity2.this);
                adapterPre.setAlbumList(listPre);
                listViewPre=(ListView)findViewById(R.id.previousListView);
                listViewPre.setAdapter(adapterPre);
    ...
    public void onClick(View v) {
        ...
        if(v==button_start){
            if(!selectMusicView.getText().toString().equals("未選択")) {
                ...
                /*
                Album tempAlbum=listR.get(selectcount);
                textView1.setText(tempAlbum.getName());
                selectArtistView.setText(tempAlbum.getArtist());
                */
        ...
        if(v==button_select){
            mPopupWindow = new PopupWindow(MainActivity2.this);
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            //list = new ArrayList<>();
                            list = new ArrayList<>();
                            adapterapi = new AlbumAdapter(MainActivity2.this);
    ...
    public void reserveList() {
        velreserve=new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                adapterReserveapi = new AlbumAdapter(MainActivity2.this);
